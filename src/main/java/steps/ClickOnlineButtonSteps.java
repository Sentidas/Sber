...
public class ClickOnlineButtonSteps extends BaseSteps{
    ...
    public void checkPageTitle(String expectedTitle) {
        String actualTitle = new ClickOnlineButtonPage(driver).title.getText();
    ...
    public void sendButton(String menuItem) {
        new ClickOnlineButtonPage(driver).sendButton(menuItem);
    }
}
